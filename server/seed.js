...
const users = [
    { name: 'Admin User', email: 'admin@eventflow.com', password: 'password123', role: 'admin' },
    { name: 'Demo User', email: 'user@eventflow.com', password: 'password123', role: 'user' },
...
const seedDatabase = async () => {
    try {
        ...
        console.log('User Email:  user@eventflow.com');
